...
| **WebSocket session**  | `DEFAULT_SESSION_MINUTES`   | `120` min                                                | Default session length (fixed — no startup prompt)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
The **default of 120 minutes** is chosen deliberately:

| Metric                                          | Value at 120 min                                                                                 |
|-------------------------------------------------|--------------------------------------------------------------------------------------------------|
| Low-latency iterations (`low_latency_analysis`) | $120 \times 60 / 1 = \mathbf{7{,}200}$                                                           |
| Historical iterations (`historical_analysis`)   | $120 \times 60 / 60 = \mathbf{120}$                                                              |
| Order book snapshots in history                 | up to $120 \times 60 \times 10 = \mathbf{72{,}000}$ ticks (capped at `maxlen=3000` ≈ last 5 min) |
...
> **Thread Timeline** — For a step-by-step t=0s … t=120 min walkthrough of both threads, see [SYSTEM_ARCHITECTURE.md](SYSTEM_ARCHITECTURE.md).
...
6. Session duration fixed at `DEFAULT_SESSION_MINUTES` (120 min) — no user prompt.
